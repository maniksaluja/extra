...
RFSUB = {-1002410813798:"RFSUB1" , -1002376397965: "RFSUB2"}
FSUB = {-1002434732750:"FSUB1" , -1002395344425: "FSUB2"}
# PENDING_REQUEST = {-1002341255671:"PENDING1" , -1002273566865: "PENDING2"}
PENDING_REQUEST = {-1002341255671:"PENDING1"}
REACTION_CHANNEL = int(-1002410813798)
...
AUTO_DELETE_CONTENT = int(getenv('AUTO_DELETE_CONTENT', 30))
AUTO_DELETE_POST = int(getenv("AUTO_DELETE_POST" , 30))
