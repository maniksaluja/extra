...
STRING1=getenv("STRING_SESSION", "BAFfuKwAOhbDvDWrrepABSSBZq9qAvkpjf9RgMpsIguNMYPoW3F9tmLPHPRoKRLH6dr78Wto3SM7NqlprRQ03Mj38jzv2EhYDn7KRJP4tw07Znryr10XpAKXdxCPQY_0cVx4JU3EQ1a78ooQHr1Szgun7jScxYsb0fuVa2f8GHhdbG75i-qGNBd1aiwq5vaQvq0lLahiObE_Pg7joag18uvfrg6WWC6RZkgmGqYIq6SJHeFohdARZlkvm6lpkNqJtQ6AAt8FqY6mx_823gJB__68-OYByojZ6lA6MIAPKmUCVAoOcvRpPk2sAd50GkJb5NsPq9WitH4nInqsUMNYpnfjdw_YcgAAAAHPWuCnAA")
...
#Your db channel Id
DATABASE_1 = int(getenv("DATABASE_CHANNEL_1",-1002431327994)) 
DATABASE_2 = int(getenv("DATABASE_CHANNEL_2",-1002494925669))
BACKUP_DATABASE_1 = int(getenv("BACKUP_DATABASE_1",-1002475085363))
BACKUP_DATABASE_2 = int(getenv("BACKUP_DATABASE_2",-1002475085363))
...
SHORTLINK_URL = getenv("SHORTLINK_URL", "https://urlwala.com/api?")
SHORTLINK_API = getenv("SHORTLINK_API", "38a9bf9d7a789a3fefd69868cda6094b656c5f5b")
