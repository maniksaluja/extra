...
from pyrogram.storage import MemorySession
...
# Use MemorySession for temporary session storage
app = Client("my_bot", session_string=session_string, api_id=api_id, api_hash=api_hash, storage=MemorySession())
